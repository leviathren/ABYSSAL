/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="comment-widgetrock.js"></script>
...
const s_stylePath = '/comment-widget-rock.css';
const s_formId = '1FAIpQLSd2emAexC347c6pDH-pGzhT0iZJvyef_AD_Ezi5Zv7W9x2ABg';
const s_nameId = '910432600';
const s_websiteId = '641674845';
const s_songId = '1138604778';
const s_textId = '1657848203';
const s_moderatedId = '1774564828';
...
const s_widgetTitle = 'Join the Crowd';
const s_nameFieldLabel = 'Stage Name';
const s_websiteFieldLabel = 'Website';
const s_songFieldLabel = 'Song Recommendation';
const s_textFieldLabel = 'Shout!';
const s_submitButtonLabel = 'Send It';
const s_loadingText = 'Loading comments...';
const s_noCommentsText = 'No comments yet!';
const s_closedCommentsText = 'Comments are closed for now';
...
const v_formHtml = `
    ...
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <input class="c-input c-nameInput smt-current-element" title="what to call you" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>
    ...
    <div id="c_songWrapper" class="c-inputWrapper">
        <label class="c-label c-songLabel" for="entry.${s_songId}">${s_songFieldLabel}</label>
        <input class="c-input c-songInput smt-current-element" title="whatcha listening to?" name="entry.${s_songId}" id="entry.${s_songId}" type="text" maxlength="${s_maxLength}">
    </div>
...
function getComments() {
    ...
    document.getElementById(`entry.${s_songId}`).value = '';
...
function createComment(data) {
    ...
    // Song Rec, if one was provided
    if (data.Song) {
        let song = document.createElement('p');
        song.innerText = s_songText;
        song.className = 'c-song';
        comment.appendChild(song);
    }
