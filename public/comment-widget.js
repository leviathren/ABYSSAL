...
const s_formId = '1FAIpQLSfsVM8XdDdztY2qa3OdnZgWl837vw-KiTZBELt4GYVkSOkUMw';
...
const s_widgetTitle = 'bottle a message';
...
const s_loadingText = 'Gathering thoughts...';
const s_noCommentsText = 'No messages yet...';
...
`;
const v_formHtml = `
    <h2 class="smt-current-element" title="comment widget by ayano at virtualobserver.moe" id="c_widgetTitle">${s_widgetTitle}</h2>

    <div id="c_nameWrapper" class="c-inputWrapper">
        <label class="c-label c-nameLabel" for="entry.${s_nameId}">${s_nameFieldLabel}</label>
        <input class="c-input c-nameInput smt-current-element" title="who goes there?"" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>
